...
Use the published CDN build when there is one — check `npm view @foxy.io/inflow version`. If you are on an unreleased version and have to serve `dist/cdn` yourself, two things matter:
